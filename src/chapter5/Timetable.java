...
public class Timetable {
	 ...
	 * @param av1 
	 */
	public void addProfessor(int professorId, String professorName, Availability av) {
	    this.professors.put(professorId, new Professor(professorId, professorName));
	    this.professorsAvailability.put(professorId, av);
	}
    ...
    public Availability getProfessorsAvailability(int id) {
